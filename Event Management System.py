...
def Open_main_window():
    ...
    tk.Button(root, text="Plot Costs", command=lambda: plot_graph(5, "Event Budgets", "Budget (Rupees)"), width=20,
              bg='blue', fg='white').pack(pady=10)
    tk.Button(root, text="Plot Guests", command=lambda: plot_graph(1, "Event Guests", "Number of Guests"), width=20,
              bg='blue', fg='white').pack(pady=10)
    tk.Button(root, text="Plot Atendees", command=lambda: plot_graph(2, "Event Atendees", "Number of Atendee"),
              width=20, bg='blue', fg='white').pack(pady=10)
    tk.Button(root, text="Plot Profits", command=lambda: plot_graph(7, "Event Profits", "Profit (Rupees)"), width=20,
              bg='blue', fg='white').pack(pady=10)
